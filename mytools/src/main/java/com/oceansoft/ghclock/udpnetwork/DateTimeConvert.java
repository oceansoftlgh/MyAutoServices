...
public class DateTimeConvert {
	...
	public Date getNowDate() {
		Date date;
		try {
			date = getAddDayTime(new Date(), -LocalSession.dayDiff);
			date = getAddSecondTime(date, -LocalSession.secondsDiff);
			return date;
