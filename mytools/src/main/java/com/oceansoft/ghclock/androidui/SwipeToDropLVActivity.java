...
import com.oceansoft.ghclock.swipetodrop.SwipeDismissRecyclerViewTouchListener;
 ...
 */
public class SwipeToDropLVActivity  extends Activity{

	private void showDialog(String msg){
		AlertDialog alert = new AlertDialog.Builder(SwipeToDropLVActivity.this)
				.setTitle("alert")
				.setMessage(msg)
				.setCancelable(false)
				.create();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_swipedrop_smaple_main);
