 ...
 * PustClickOpenCustomActivity;end 确认推送后，手机将会收到通知，点击通知后，将打开CustomActivity
 * 
 ...
 * C . 9 F
 */
public class PustClickOpenCustomActivity extends Activity {
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(resource.getIdentifier("baidupush_custom_activity", "layout",
                pkgName));
    }
}
