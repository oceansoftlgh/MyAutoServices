...
import com.oceansoft.ghclock.androidui.PushDemoActivity;
...
public class BaiduLoginActivity extends Activity {
    ...
    private void getAccessToken() {
        String url = DEV_CENTER + "oauth/2.0/authorize?"
                ...
                + Utils.getMetaValue(BaiduLoginActivity.this, "api_key")
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if (url.startsWith(REDIRECT) || url.contains("login_success")) {
                    ...
                    Toast.makeText(BaiduLoginActivity.this,
                            "get access token success", Toast.LENGTH_SHORT)
                            .show();

                    // ͨ登录
                    Intent intent = new Intent(Utils.ACTION_LOGIN);
                    intent.setClass(BaiduLoginActivity.this, PushDemoActivity.class);
