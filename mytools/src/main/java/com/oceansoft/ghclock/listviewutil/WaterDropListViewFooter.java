 ...
 */
package com.oceansoft.ghclock.listviewutil;
...
public class WaterDropListViewFooter extends LinearLayout {
    ...
    private void initView(Context context) {
        mContext = context;
        LinearLayout moreView = (LinearLayout) LayoutInflater.from(mContext).inflate(R.layout.listview_uptoload_footer, null);
        addView(moreView);
